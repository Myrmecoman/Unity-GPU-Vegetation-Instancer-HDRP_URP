...
public class BillboardGrassInstancer : MonoBehaviour
{
    public static BillboardGrassInstancer instance;
    ...
    private Dictionary<int4, BillboardGrassChunk> chunksData;
    ...
    private void UpdateAllVariables()
    {
        ...
        chunksData = new Dictionary<int4, BillboardGrassChunk>(1024);
    ...
    private void DisposeChunk(BillboardGrassChunk g)
    {
    ...
    private BillboardGrassChunk InitializeChunk(int4 center)
    {
        var chunk = new BillboardGrassChunk();
    ...
    private void UpdateChunks()
    {
        ...
        var chunksSampler = new PickVisibleChunksJob
        {
            ...
            chunkSize = chunkSize,
            viewDistanceLODSq = viewDistance * viewDistance,
...
public struct BillboardGrassChunk
{
